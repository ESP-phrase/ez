...
export const metadata: Metadata = {
  ...
  description:
    "Get an unfair edge on prediction markets. AI market analysis, expert daily picks, copy trading, and live BTC signals. Trusted by 300+ traders. Start winning for $1.",
  alternates: { canonical: "https://polygoat.io" },
  openGraph: {
    title: "PolyGoat — AI Trading Tools for Polymarket & Kalshi",
    description: "AI analysis, expert picks, copy trading & BTC signals for Polymarket and Kalshi. Start winning for $1.",
        ...
        <section className="py-28 px-4 text-center">
          <div className="max-w-xl mx-auto">
            ...
            <p className="text-white/45 text-sm mb-10">
              Trusted by over 300 traders. Start winning for $1. Cancel any time.
            </p>
            <Link
              href="/start"
