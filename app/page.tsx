...
export const metadata: Metadata = {
  ...
  description:
    "AI-powered tools for smarter prediction market trading. Market analysis, daily picks, copy trading, and live BTC signals for Polymarket and Kalshi. Try for $1.",
  alternates: { canonical: "https://polygoat.io" },
  openGraph: {
    title: "PolyGoat — AI Trading Tools for Polymarket & Kalshi",
    description: "AI analysis, expert picks, copy trading & BTC signals for Polymarket and Kalshi. Try for $1.",
        ...
        <section className="py-28 px-4 text-center">
          <div className="max-w-xl mx-auto">
            ...
            <p className="text-white/45 text-sm mb-10">
              Trusted by over 300 traders. Try for $1. Cancel any time.
            </p>
            <Link
              href="/start"
